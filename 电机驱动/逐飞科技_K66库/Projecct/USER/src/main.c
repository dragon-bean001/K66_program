...
int main(void)
{
  ...
  //相关的库函数在 MK60DN10_ftm.c 里面
	...
	ftm_pwm_init(ftm3,ftm_ch1|ftm_ch2|ftm_ch3|ftm_ch4,50,1950);//初始化ftm0模块，0通道为50HZ，占空比为百分之50，默认精度为1000 引脚对应查看MK60DN10_port_cfg.h
   ...
   while(1)
	 {
		 ...
		 ftm_pwm_duty(ftm3,ftm_ch2,200);//motor4
		 ftm_pwm_duty(ftm3,ftm_ch3,0);//motor1
		 ftm_pwm_duty(ftm3,ftm_ch4,200);//motor2
	 }
 }
